"""
Web autorun config manager.
Gestiona el arranque automático persistente del servidor web.
"""
...
class WebAutorunConfigManager:
	"""Gestiona la persistencia de autorun del servidor web."""
	...
	def load_config(self) -> dict:
		...
		try:
			...
			logger.error(f"Error cargando autorun web: {exc}")

		return self._default_config()

	def save_config(self, autorun: bool) -> None:
		"""Guarda el estado de autorun del servidor web."""
		payload = {
		...
		try:
			...
			logger.error(f"Error guardando autorun web: {exc}")
...
def create_web_autorun_manager() -> WebAutorunConfigManager:
	"""Factory de conveniencia para manager de autorun web."""
	return WebAutorunConfigManager()
